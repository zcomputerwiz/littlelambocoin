...
import littlelambocoin.cmds.configure as littlelambocoin_configure
...
from littlelambocoin.seeder.util.config import patch_default_seeder_config
from littlelambocoin.seeder.util.service_groups import all_groups, services_for_groups
from littlelambocoin.seeder.util.service import launch_service, kill_service
...
def configure(
    ...
    littlelambocoin_configure.configure(root_path, "", "", "", "", "", "", "", "", testnet, "")
