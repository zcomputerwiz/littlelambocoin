...
The Linux and MacOS littlelambocoinvdf binary wheels currently exclude an executable
...
invoking pip to build from the source python distribution of littlelambocoinvdf.

The `install-timelord.sh` install script leverages two environmental variables
that the littlelambocoinvdf wheels can use to specify how to build. The service that the
